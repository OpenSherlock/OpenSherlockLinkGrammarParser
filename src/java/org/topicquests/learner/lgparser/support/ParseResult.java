 ...
 * and a list of <code>ResultLinkage</code>s returned by the parser. The
 ...
 *
 */
public class ParseResult implements Iterable<ResultLinkage>
{
	...
	List<ResultLinkage> linkages = new ArrayList<ResultLinkage>();
	int numSkippedWords;
	...
	public Iterator<ResultLinkage> iterator()
	{
		return linkages.iterator();
	}

	public List<ResultLinkage> getLinkages()
	{
		return linkages;
	}
