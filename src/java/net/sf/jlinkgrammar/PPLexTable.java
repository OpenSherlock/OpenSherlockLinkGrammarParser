...
public class PPLexTable {
    ...
    public String labels[] = new String[IParserConstants.PP_LEXER_MAX_LABELS];
    /** str. for each label */
    public PPLabelNode nodes_of_label[] = new PPLabelNode[IParserConstants.PP_LEXER_MAX_LABELS];
    /** efficiency */
    public PPLabelNode last_node_of_label[] = new PPLabelNode[IParserConstants.PP_LEXER_MAX_LABELS];
    ...
    PPLexTable() {
        for (int i = 0; i < IParserConstants.PP_LEXER_MAX_LABELS; i++) {
    ...
    public void set_label(String label) {
        ...
        /* new label. Store it */
        if (i == IParserConstants.PP_LEXER_MAX_LABELS - 1)
