 ...
 * copied to the Sentence instance object, and then to the various ResultLinkage instance objects.
...
public class Postprocessor {
     ...
     */
    boolean visited[] = new boolean[IParserConstants.MAX_SENTENCE];
    /**
    ...
    static void build_domains(Postprocessor pp, Sublinkage sublinkage) {
        ...
        for (link = 0; link < sublinkage.num_links; link++) {
            ...
            if (PPLinkset.PPLinkset_match(pp.knowledge.domain_starter_links, s)) {
                ...
                if (!(pp.pp_data.N_domains < IParserConstants.PP_MAX_DOMAINS)) {
    ...
    static boolean contained_in(Domain d1, Domain d2, Sublinkage sublinkage) {
        /*  */
        boolean mark[] = new boolean[IParserConstants.MAX_LINKS];
        ListOfLinks lol;
